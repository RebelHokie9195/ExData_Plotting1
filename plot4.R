...
par(mfrow=c(2,2))
plot(data3$datetime2,data3$Global_active_power,type="l",ylab="Global Active Power")
plot(data3$datetime2,data3$Voltage,type="l",ylab="Voltage")
...
plot(data3$datetime2,data3$Global_reactive_power,type="l",ylab="Global_reactive_power")
dev.off()